...
public class BannerAdapter extends RecyclerView.Adapter<BannerAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
        ...
        final View sView = mInflater.inflate (R.layout.list_item_banner, parent, false);
    ...
    public void SetOnItemClickListener (final BannerAdapter.OnItemClickListener mItemClickListener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick (View v) {
            Banner banner = bannerList.get (getLayoutPosition ());
