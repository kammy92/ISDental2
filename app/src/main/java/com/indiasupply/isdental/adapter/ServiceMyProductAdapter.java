...
public class ServiceMyProductAdapter extends RecyclerView.Adapter<ServiceMyProductAdapter.ViewHolder> {
    OnItemClickListener mItemClickListener;
    private Activity activity;
    private List<MyProduct> myProductList = new ArrayList<> ();
    
    public ServiceMyProductAdapter (Activity activity, List<MyProduct> myProductList) {
    ...
    public ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
        ...
        final View sView = mInflater.inflate (R.layout.list_item_service_my_product, parent, false);
        return new ViewHolder (sView);
    }
    
    @Override
    public void onBindViewHolder (final ViewHolder holder, int position) {
        final MyProduct product = myProductList.get (position);
