...
public class SwiggyMyAccountEnquiryAdapter extends RecyclerView.Adapter<SwiggyMyAccountEnquiryAdapter.ViewHolder> {
    OnItemClickListener mItemClickListener;
    private Activity activity;
    private List<SwiggyMyAccountEnquiry> myAccountEnquiryList = new ArrayList<> ();
    
    public SwiggyMyAccountEnquiryAdapter (Activity activity, List<SwiggyMyAccountEnquiry> myAccountEnquiryList) {
    ...
    public ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
        ...
        final View sView = mInflater.inflate (R.layout.list_item_swiggy_my_account_enquiries, parent, false);
