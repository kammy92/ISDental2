...
public class ServiceItemAdapter extends RecyclerView.Adapter<ServiceItemAdapter.ViewHolder> {
    ...
    public ServiceItemAdapter (Activity activity, List<ServiceItem> serviceItemList) {
    ...
    public ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
        ...
        final View sView = mInflater.inflate (R.layout.list_item_service_item, parent, false);
