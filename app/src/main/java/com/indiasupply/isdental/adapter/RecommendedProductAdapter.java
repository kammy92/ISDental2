...
import com.indiasupply.isdental.dialog.RecommendedProductDialogFragment;
...
public class RecommendedProductAdapter extends RecyclerView.Adapter<RecommendedProductAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
        ...
        final View sView = mInflater.inflate (R.layout.list_item_product_recommended_small, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick (View v) {
         /*   FragmentTransaction ft = activity.getFragmentManager ().beginTransaction ();
            RecommendedProductDialogFragment frag = new RecommendedProductDialogFragment ();
            frag.show (ft, "rahul");*/
            android.app.FragmentTransaction ft = activity.getFragmentManager ().beginTransaction ();
            new RecommendedProductDialogFragment ().newInstance (productList, getLayoutPosition ()).show (ft, "Products");
        }
    }
}