...
public class MyAccountOfferAdapter extends RecyclerView.Adapter<MyAccountOfferAdapter.ViewHolder> {
    OnItemClickListener mItemClickListener;
    private Activity activity;
    private List<MyAccountOffer> myAccountOfferList = new ArrayList<> ();
    
    public MyAccountOfferAdapter (Activity activity, List<MyAccountOffer> myAccountOfferList) {
    ...
    public ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
        ...
        final View sView = mInflater.inflate (R.layout.list_item_my_account_offers, parent, false);
        return new ViewHolder (sView);
    }
    
    @Override
    public void onBindViewHolder (final ViewHolder holder, int position) {//        runEnterAnimation (holder.itemView);
        final MyAccountOffer myAccountOffer = myAccountOfferList.get (position);
