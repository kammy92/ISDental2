...
public class RecommendedProductAdapter2 extends RecyclerView.Adapter<RecommendedProductAdapter2.ViewHolder> {
    RecommendedProductAdapter2.OnItemClickListener mItemClickListener;
    private Activity activity;
    private List<Product> productList = new ArrayList<> ();
    
    public RecommendedProductAdapter2 (Activity activity, List<Product> productList) {
    ...
    public ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
        ...
        final View sView = mInflater.inflate (R.layout.list_item_product_recommended_large, parent, false);
    ...
    public void SetOnItemClickListener (final RecommendedProductAdapter2.OnItemClickListener mItemClickListener) {
