...
public class ServiceRequestCommentsAdapter extends RecyclerView.Adapter<ServiceRequestCommentsAdapter.ViewHolder> {
    OnItemClickListener mItemClickListener;
    private Activity activity;
    private List<ServiceRequestComments> commentsList = new ArrayList<> ();
    
    public ServiceRequestCommentsAdapter (Activity activity, List<ServiceRequestComments> commentsList) {
    ...
    public ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
        ...
        final View sView = mInflater.inflate (R.layout.list_item_service_request_comment, parent, false);
        return new ViewHolder (sView);
    }
    
    @Override
    public void onBindViewHolder (final ViewHolder holder, int position) {
        final ServiceRequestComments comments = commentsList.get (position);
