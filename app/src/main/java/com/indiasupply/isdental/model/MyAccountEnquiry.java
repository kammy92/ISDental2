...
public class MyAccountEnquiry {
    ...
    public MyAccountEnquiry (int id, int enquiry_status, String enquiry_ticket_number, String enquiry_remark, String company_name, String product_name, String product_price, String product_category, String product_image, String product_description, String product_packaging, String enquiry_comment) {
        this.id = id;
