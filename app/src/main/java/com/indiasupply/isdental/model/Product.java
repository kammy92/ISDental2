...
public class Product implements Parcelable {
    public static final Creator<Product> CREATOR = new Creator<Product> () {
        ...
        public Product createFromParcel (Parcel in) {
            ...
            return new Product (id, icon, enquiry_status, name, description, packaging, category, price, group_type, group_title, image);
        }
    ...
    public Product (int id, int icon, int enquiry_status, String name, String description, String packaging, String category, String price, int group_type, String group_title, String image) {
        this.id = id;
        this.icon = icon;
