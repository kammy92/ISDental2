...
public class MyProduct2 {
    ...
    public MyProduct2 (int id, int icon, String name, String description, String brand, String model_number, String serial_number, String purchase_date, String request_created_at, String request_status, String request_ticket_number, String image) {
        this.id = id;
        this.icon = icon;
        this.name = name;
