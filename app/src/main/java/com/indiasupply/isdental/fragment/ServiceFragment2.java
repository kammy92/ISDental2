...
import com.indiasupply.isdental.adapter.ServiceMyProductAdapter2;
...
public class ServiceFragment2 extends Fragment {
    ...
    ServiceMyProductAdapter2 serviceMyProductAdapter2;
    List<MyProduct2> swiggyServiceItemList = new ArrayList<> ();
    ...
    public static ServiceFragment2 newInstance (boolean refresh) {
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate (R.layout.fragment_service2, container, false);
        initView (root);
        initBundle ();
        initData ();
        initListener ();
...
//        setData ();
    ...
    private void initData () {
        ...
        serviceMyProductAdapter2 = new ServiceMyProductAdapter2 (getActivity (), swiggyServiceItemList);
        rvServiceList.setNestedScrollingEnabled (false);
        rvServiceList.setFocusable (false);
        rvServiceList.setAdapter (serviceMyProductAdapter2);
