...
import com.indiasupply.isdental.adapter.SwiggyOfferAdapter;
...
public class SwiggyOffersFragment extends Fragment {
    RecyclerView rvOffers;
    ImageView ivBanner;
    ShimmerFrameLayout shimmerFrameLayout;
    List<SwiggyBanner> bannerList = new ArrayList<> ();
    List<SwiggyOffers> offerList = new ArrayList<> ();
    SwiggyOfferAdapter offerAdapter;
    ...
    public static SwiggyOffersFragment newInstance (boolean refresh) {
        SwiggyOffersFragment fragment = new SwiggyOffersFragment ();
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate (R.layout.fragment_swiggy_offers, container, false);
        initView (rootView);
        initBundle ();
        initData ();
        initListener ();
    ...
    private void initData () {
        ...
        offerAdapter = new SwiggyOfferAdapter (getActivity (), offerList);
        ...
        rvOffers.addItemDecoration (new RecyclerViewMargin (
                ...
                (int) Utils.pxFromDp (getActivity (), 16),
                0,
                0, 1, 0, RecyclerViewMargin.LAYOUT_MANAGER_LINEAR, RecyclerViewMargin.ORIENTATION_VERTICAL));
                                    ...
                                    try {
                                        ...
                                        if (! is_error) {
                                            ...
                                            for (int j = 0; j < jsonArrayOffers.length (); j++) {
                                                ...
                                                offerList.add (new SwiggyOffers (
                                                        ...
                                                        jsonObjectOffer.getString (AppConfigTags.SWIGGY_OFFER_MRP),
                                                        jsonObjectOffer.getString (AppConfigTags.SWIGGY_OFFER_REGULAR_PRICE),
                                                        jsonObjectOffer.getString (AppConfigTags.SWIGGY_OFFER_PRICE),
                                                        jsonObjectOffer.getString (AppConfigTags.SWIGGY_OFFER_SAVING),
