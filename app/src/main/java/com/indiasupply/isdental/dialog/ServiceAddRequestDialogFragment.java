...
import com.indiasupply.isdental.fragment.ServiceFragment;
...
public class ServiceAddRequestDialogFragment extends DialogFragment {
    ServiceFragment.MyDialogCloseListener closeListener;
    ImageView ivCancel;
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate (R.layout.fragment_dialog_service_add_request, container, false);
        initView (root);
        initBundle ();
        initData ();
        initListener ();
    ...
    public void setDismissListener (ServiceFragment.MyDialogCloseListener closeListener) {
