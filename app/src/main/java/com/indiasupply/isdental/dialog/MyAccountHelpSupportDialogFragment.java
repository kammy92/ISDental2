...
public class MyAccountHelpSupportDialogFragment extends DialogFragment {
    ImageView ivCancel;
    WebView webView;
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate (R.layout.fragment_dialog_my_account_help_support, container, false);
        initView (root);
        initBundle ();
        initData ();
        initListener ();
