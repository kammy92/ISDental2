...
public class SwiggyMyAccountTermsofUseDialogFragment extends DialogFragment {
    ImageView ivCancel;
    WebView webView;
    ...
    public static SwiggyMyAccountTermsofUseDialogFragment newInstance (String htmlTermsOfUse) {
        SwiggyMyAccountTermsofUseDialogFragment fragment = new SwiggyMyAccountTermsofUseDialogFragment ();
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate (R.layout.fragment_dialog_swiggy_my_account_terms_of_use, container, false);
        initView (root);
        initBundle ();
        initData ();
        initListener ();
    ...
    private void getWebView () {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder (htmlTermsOfUse);
