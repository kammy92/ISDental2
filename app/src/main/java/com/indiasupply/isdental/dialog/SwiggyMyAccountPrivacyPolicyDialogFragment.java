...
public class SwiggyMyAccountPrivacyPolicyDialogFragment extends DialogFragment {
    ImageView ivCancel;
    WebView webView;
    ...
    public static SwiggyMyAccountPrivacyPolicyDialogFragment newInstance (String htmlPrivacyPolicy) {
        SwiggyMyAccountPrivacyPolicyDialogFragment fragment = new SwiggyMyAccountPrivacyPolicyDialogFragment ();
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate (R.layout.fragment_dialog_swiggy_my_account_privacy_policy, container, false);
        initView (root);
        initBundle ();
        initData ();
        initListener ();
    ...
    private void getWebView () {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder ("<style>@font-face{font-family: myFont; src: url(file:///android_asset/" + Constants.font_name + ");}</style>" + htmlPrivacyPolicy);
