...
public class SwiggyEventInformationDialogFragment extends DialogFragment {
    ...
    public static SwiggyEventInformationDialogFragment newInstance (String eventInformation) {
        SwiggyEventInformationDialogFragment fragment = new SwiggyEventInformationDialogFragment ();
    ...
    private void getWebView () {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder ("<style>@font-face{font-family: myFont; src: url(file:///android_asset/" + Constants.font_name + ");}</style>" + eventInformation);
