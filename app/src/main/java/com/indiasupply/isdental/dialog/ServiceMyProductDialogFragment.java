...
import com.indiasupply.isdental.adapter.ServiceMyProductAdapter;
import com.indiasupply.isdental.model.MyProduct;
...
public class ServiceMyProductDialogFragment extends DialogFragment {
    ImageView ivCancel;
    TextView tvTitle;
    RecyclerView rvMyProducts;
    CoordinatorLayout clMain;
    ServiceMyProductAdapter productAdapter;
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate (R.layout.fragment_dialog_service_my_product, container, false);
        initView (root);
        initBundle ();
        initData ();
        initListener ();
    ...
    private void initData () {
        ...
        productAdapter = new ServiceMyProductAdapter (getActivity (), myProductList);
