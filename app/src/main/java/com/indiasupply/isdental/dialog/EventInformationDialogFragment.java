...
public class EventInformationDialogFragment extends DialogFragment {
    ImageView ivCancel;
    WebView webView;
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate (R.layout.fragment_dialog_event_information, container, false);
        initView (root);
        initBundle ();
        initData ();
        initListener ();
