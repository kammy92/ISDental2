...
public class MyAccountPrivacyPolicyDialogFragment extends DialogFragment {
    ImageView ivCancel;
    WebView webView;
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate (R.layout.fragment_dialog_my_account_privacy_policy, container, false);
        initView (root);
        initBundle ();
        initData ();
        initListener ();
