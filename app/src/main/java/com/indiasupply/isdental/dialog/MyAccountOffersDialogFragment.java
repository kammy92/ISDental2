...
import com.indiasupply.isdental.adapter.MyAccountOfferAdapter;
import com.indiasupply.isdental.model.MyAccountOffer;
...
public class MyAccountOffersDialogFragment extends DialogFragment {
    RecyclerView rvMyOffers;
    List<MyAccountOffer> myAccountOfferList = new ArrayList<> ();
    MyAccountOfferAdapter myAccountOfferAdapter;
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate (R.layout.fragment_dialog_my_account_offers, container, false);
        initView (root);
        initBundle ();
        initData ();
        initListener ();
    ...
    private void initData () {
        ...
        myAccountOfferAdapter = new MyAccountOfferAdapter (getActivity (), myAccountOfferList);
    ...
    private void setData () {
        List<MyAccountOffer> tempMyAccountOfferList = new ArrayList<> ();
        try {
            ...
            if (jsonArrayOffer.length () > 0) {
                for (int i = 0; i < jsonArrayOffer.length (); i++) {
                    ...
                    tempMyAccountOfferList.add (new MyAccountOffer (
                ...
                for (int i = 0; i < tempMyAccountOfferList.size (); i++) {
                    MyAccountOffer offer = tempMyAccountOfferList.get (i);
