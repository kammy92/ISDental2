...
public class EventExhibitorDialogFragment extends DialogFragment {
    RecyclerView rvExhibitor;
    List<EventExhibitor> exhibitorList = new ArrayList<> ();
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate (R.layout.fragment_dialog_event_exhibitors, container, false);
        initView (root);
        initBundle ();
        initData ();
        initListener ();
    ...
    private void initData () {
        ...
        exhibitorAdapter = new EventExhibitorAdapter (getActivity (), exhibitorList);
