...
public class EventRegistrationsDialogFragment extends DialogFragment {
    ImageView ivCancel;
    WebView webView;
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate (R.layout.fragment_dialog_event_registration, container, false);
        initView (root);
        initBundle ();
        initData ();
        initListener ();
