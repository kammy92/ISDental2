...
public class ServiceAddProductDialogFragment extends DialogFragment {
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate (R.layout.fragment_dialog_service_add_product, container, false);
        initView (root);
        initBundle ();
        initData ();
        initListener ();
