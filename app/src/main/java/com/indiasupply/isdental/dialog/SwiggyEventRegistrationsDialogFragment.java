...
public class SwiggyEventRegistrationsDialogFragment extends DialogFragment {
    ...
    public static SwiggyEventRegistrationsDialogFragment newInstance (String eventRegistration) {
        SwiggyEventRegistrationsDialogFragment fragment = new SwiggyEventRegistrationsDialogFragment ();
    ...
    private void getWebView () {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder (eventRegistration);
