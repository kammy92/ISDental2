...
import com.indiasupply.isdental.adapter.ServiceRequestCommentsAdapter;
import com.indiasupply.isdental.model.ServiceRequestComments;
...
public class ServiceRequestDetailDialogFragment extends DialogFragment {
    ...
    List<ServiceRequestComments> serviceRequestCommentsList = new ArrayList<> ();
    ServiceRequestCommentsAdapter serviceRequestCommentsAdapter;
    
    public ServiceRequestDetailDialogFragment newInstance (String Response, int Request_id) {
        ServiceRequestDetailDialogFragment fragment = new ServiceRequestDetailDialogFragment ();
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate (R.layout.fragment_dialog_service_request_detail, container, false);
        initView (root);
        initBundle ();
        initData ();
        initListener ();
    ...
    private void initData () {
        ...
        serviceRequestCommentsAdapter = new ServiceRequestCommentsAdapter (getActivity (), serviceRequestCommentsList);
            ...
            for (int i = 0; i < jsonArrayRequest.length (); i++) {
                ...
                if (jsonObjectRequest.getInt (AppConfigTags.REQUEST_ID) == Request_id) {
                    ...
                    for (int j = 0; j < jsonArrayComments.length (); j++) {
                        ...
                        serviceRequestCommentsList.add (j, new ServiceRequestComments (
    ...
    private void initListener () {
        ...
        rl5.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick (View view) {
                ...
                ServiceAddNewRequestDialogFragment dialog = new ServiceAddNewRequestDialogFragment ()
                            ...
                            if (response != null) {
                                try {
                                    ...
                                    if (! error) {
                                        ...
                                        serviceRequestCommentsList.add (new ServiceRequestComments (
                                                0,
                                                "YOU",
                                                replyComment,
                                                0,
