...
import com.indiasupply.isdental.adapter.ServiceMyRequestAdapter;
...
public class ServiceMyRequestDialogFragment extends DialogFragment {
    TextView tvTitle;
    ImageView ivCancel;
    RecyclerView rvRequests;
    ServiceMyRequestAdapter myRequestAdapter;
    List<MyRequest> myRequestList = new ArrayList<> ();
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate (R.layout.fragment_dialog_service_my_request, container, false);
        initView (root);
        initBundle ();
        initData ();
        initListener ();
    ...
    private void initData () {
        ...
        myRequestAdapter = new ServiceMyRequestAdapter (getActivity (), myRequestList);
