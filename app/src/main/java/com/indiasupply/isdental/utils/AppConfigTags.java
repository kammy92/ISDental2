...
public class AppConfigTags {
    ...
    public static final String COMPANY_BRANDS = "company_brands";
    ...
    public static final String CONTACT_OPEN_TIME = "contact_open_time";
    public static final String CONTACT_CLOSE_TIME = "contact_close_time";
    public static final String CONTACT_HOLIDAY = "contact_holidays";
    ...
    public static final String EVENT_PINCODE = "event_pincode";
    ...
    public static final String SWIGGY_PRODUCT_ENQUIRY = "product_enquiry";
