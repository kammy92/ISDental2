...
public class MainActivity extends AppCompatActivity {
    ...
    private void initFirstFragment () {
        bottomNavigationView.getMenu ().findItem (R.id.action_item_offers).setIcon (R.drawable.ic_home_offer_filled);
...
//        }
        ...
        menu.findItem (R.id.action_item_offers).setIcon (R.drawable.ic_home_offer);
...
//                        menu.findItem (R.id.action_item_account).setIcon (R.drawable.ic_home_account);
                        ...
                        switch (item.getItemId ()) {
                            case R.id.action_item_offers:
                                item.setIcon (R.drawable.ic_home_offer_filled);
                                if (screenList.contains (R.id.action_item_offers)) {
                                    selectedFragment = OffersFragment.newInstance (false);
                                } else {
                                    selectedFragment = OffersFragment.newInstance (true);
                                }
...
//        super.onBackPressed ();
        ...
        if (bottomNavigationView.getSelectedItemId () == R.id.action_item_offers) {
